...
/**
 * Renderer that converts VictorOps alert channels to a text file.
 * 
...
public class VictorOpsChannelRenderer extends OutputFileRenderer<VictorOpsChannel>
{
    ...
    {
        TemplateFactory.registerTemplate(VictorOpsChannelRenderer.class, template);
    }
     ...
     */
    public static void write(List<VictorOpsChannel> channels, OutputFileWriter writer) throws IOException
    {
        new VictorOpsChannelRenderer().render(channels, writer);
    }
     ...
     */
    protected String[] serialize(FileTemplate template, VictorOpsChannel channel)
    {
        List<String> line = new ArrayList<String>();
        line.add(channel.getName());
        line.add(template.getType());
        line.add(channel.getConfiguration().getKey());
        line.add(channel.getConfiguration().getRouteKey());
