...
/**
 * Renderer that converts PagerDuty alert channels to a text file.
 * 
 * @author Gerald Curley (opsmatters)
 */
public class PagerDutyChannelRenderer extends OutputFileRenderer<PagerDutyChannel>
{
    private static final Logger logger = Logger.getLogger(PagerDutyChannelRenderer.class.getName());

    /**
     * Private constructor.
     */
    private PagerDutyChannelRenderer()
    {
    }
    ...
    {
        TemplateFactory.registerTemplate(PagerDutyChannelRenderer.class, template);
    }
     ...
     */
    public static void write(List<PagerDutyChannel> channels, OutputFileWriter writer) throws IOException
    {
        new PagerDutyChannelRenderer().render(channels, writer);
    }
     ...
     */
    protected String[] serialize(FileTemplate template, PagerDutyChannel channel)
    {
        List<String> line = new ArrayList<String>();
        line.add(channel.getName());
        line.add(template.getType());
        line.add(channel.getConfiguration().getServiceKey());
