...
/**
 * Renderer that converts Campfire alert channels to a text file.
 * 
...
public class CampfireChannelRenderer extends OutputFileRenderer<CampfireChannel>
{
    ...
    {
        TemplateFactory.registerTemplate(CampfireChannelRenderer.class, template);
    }
     ...
     */
    public static void write(List<CampfireChannel> channels, OutputFileWriter writer) throws IOException
    {
        new CampfireChannelRenderer().render(channels, writer);
    }
     ...
     */
    protected String[] serialize(FileTemplate template, CampfireChannel channel)
    {
        List<String> line = new ArrayList<String>();
        line.add(channel.getName());
        line.add(template.getType());
        line.add(channel.getConfiguration().getSubdomain());
        line.add(channel.getConfiguration().getToken());
        line.add(channel.getConfiguration().getRoom());
