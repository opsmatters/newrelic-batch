...
/**
 * Renderer that converts xMatters alert channels to a text file.
 * 
...
public class xMattersChannelRenderer extends OutputFileRenderer<xMattersChannel>
{
    ...
    {
        TemplateFactory.registerTemplate(xMattersChannelRenderer.class, template);
    }
     ...
     */
    public static void write(List<xMattersChannel> channels, OutputFileWriter writer) throws IOException
    {
        new xMattersChannelRenderer().render(channels, writer);
    }
     ...
     */
    protected String[] serialize(FileTemplate template, xMattersChannel channel)
    {
