...
public class InfraHostNotReportingAlertConditionParser extends InfraAlertConditionParser<InfraHostNotReportingAlertCondition>
{
     ...
     */
    protected List<InfraHostNotReportingAlertCondition> get(List<AlertPolicy> policies, String[] headers, List<String[]> lines)
    {
        ...
        for(String[] line : lines)
        {
            ...
            InfraHostNotReportingAlertCondition condition = create(file, line);
            setPolicyId(condition, policyList, file.getString(InfraHostNotReportingAlertCondition.POLICY_NAME, line));
            ret.add(condition);
        }
